...
if [ ! -f dataset/Multivariate2018_ts.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Archives/Multivariate2018_ts.zip" -O dataset/Multivariate2018_ts.zip
...
if [ ! -f dataset/Univariate2018_ts.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Archives/Univariate2018_ts.zip" -O dataset/Univariate2018_ts.zip
...
if [ ! -f dataset/Blink.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Blink.zip" -O dataset/Blink.zip
    unzip dataset/Blink.zip -d dataset/Blink
fi

# MotionSenseHAR data
if [ ! -f dataset/MotionSenseHAR.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/MotionSenseHAR.zip" -O dataset/MotionSenseHAR.zip
    unzip dataset/MotionSenseHAR.zip -d dataset/MotionSenseHAR
fi

# EMOPain data
if [ ! -f dataset/EMOPain.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/EMOPain.zip" -O dataset/EMOPain.zip
...
if [ ! -f dataset/SharePriceIncrease.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/SharePriceIncrease.zip" -O dataset/SharePriceIncrease.zip
...
if [ ! -f dataset/AbnormalHeartbeat.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AbnormalHeartbeat.zip" -O dataset/AbnormalHeartbeat.zip
...
if [ ! -f dataset/AsphaltObstacles.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltObstacles.zip" -O dataset/AsphaltObstacles.zip
...
if [ ! -f dataset/AsphaltObstaclesCoordinates.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltObstaclesCoordinates.zip" -O dataset/AsphaltObstaclesCoordinates.zip
...
if [ ! -f dataset/AsphaltPavementType.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltPavementType.zip" -O dataset/AsphaltPavementType.zip
...
if [ ! -f dataset/AsphaltPavementTypeCoordinates.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltPavementTypeCoordinates.zip" -O dataset/AsphaltPavementTypeCoordinates.zip
...
if [ ! -f dataset/AsphaltRegularity.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltRegularity.zip" -O dataset/AsphaltRegularity.zip
...
if [ ! -f dataset/AsphaltRegularityCoordinates.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/AsphaltRegularityCoordinates.zip" -O dataset/AsphaltRegularityCoordinates.zip
...
if [ ! -f dataset/BinaryHeartbeat.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/BinaryHeartbeat.zip" -O dataset/BinaryHeartbeat.zip
    unzip dataset/BinaryHeartbeat.zip -d dataset/BinaryHeartbeat
fi

# CatsDogs data
if [ ! -f dataset/CatsDogs.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/CatsDogs.zip" -O dataset/CatsDogs.zip
    unzip dataset/CatsDogs.zip -d dataset/CatsDogs
fi

# Colposcopy data
if [ ! -f dataset/Colposcopy.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Colposcopy.zip" -O dataset/Colposcopy.zip
    unzip dataset/Colposcopy.zip -d dataset/Colposcopy
fi

# CounterMovementJump data
if [ ! -f dataset/CounterMovementJump.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/CounterMovementJump.zip" -O dataset/CounterMovementJump.zip
    unzip dataset/CounterMovementJump.zip -d dataset/CounterMovementJump
fi

# DucksAndGeese data
if [ ! -f dataset/DucksAndGeese.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/DucksAndGeese.zip" -O dataset/DucksAndGeese.zip
...
if [ ! -f dataset/ElectricDeviceDetection.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/ElectricDeviceDetection.zip" -O dataset/ElectricDeviceDetection.zip
    unzip dataset/ElectricDeviceDetection.zip -d dataset/ElectricDeviceDetection
fi

# Epilepsy2 data
if [ ! -f dataset/Epilepsy2.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Epilepsy2.zip" -O dataset/Epilepsy2.zip
    unzip dataset/Epilepsy2.zip -d dataset/Epilepsy2
fi

# EyesOpenShut data
if [ ! -f dataset/EyesOpenShut.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/EyesOpenShut.zip" -O dataset/EyesOpenShut.zip
    unzip dataset/EyesOpenShut.zip -d dataset/EyesOpenShut
fi

# FaultDetectionA data
if [ ! -f dataset/FaultDetectionA.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/FaultDetectionA.zip" -O dataset/FaultDetectionA.zip
    unzip dataset/FaultDetectionA.zip -d dataset/FaultDetectionA
fi

# FruitFlies data
if [ ! -f dataset/FruitFlies.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/FruitFlies.zip" -O dataset/FruitFlies.zip
    unzip dataset/FruitFlies.zip -d dataset/FruitFlies
fi

# InsectSound data
if [ ! -f dataset/InsectSound.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/InsectSound.zip" -O dataset/InsectSound.zip
    unzip dataset/InsectSound.zip -d dataset/InsectSound
fi

# KeplerLightCurves data
if [ ! -f dataset/KeplerLightCurves.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/KeplerLightCurves.zip" -O dataset/KeplerLightCurves.zip
    unzip dataset/KeplerLightCurves.zip -d dataset/KeplerLightCurves
fi

# MindReading data
if [ ! -f dataset/MindReading.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/MindReading.zip" -O dataset/MindReading.zip
    unzip dataset/MindReading.zip -d dataset/MindReading
fi

# MosquitoSound data
if [ ! -f dataset/MosquitoSound.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/MosquitoSound.zip" -O dataset/MosquitoSound.zip
    unzip dataset/MosquitoSound.zip -d dataset/MosquitoSound
fi

# NerveDamage data
if [ ! -f dataset/NerveDamage.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/NerveDamage.zip" -O dataset/NerveDamage.zip
    unzip dataset/NerveDamage.zip -d dataset/NerveDamage
fi

# RightWhaleCalls data
if [ ! -f dataset/RightWhaleCalls.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/RightWhaleCalls.zip" -O dataset/RightWhaleCalls.zip
    unzip dataset/RightWhaleCalls.zip -d dataset/RightWhaleCalls
fi

# Sleep data
if [ ! -f dataset/Sleep.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Sleep.zip" -O dataset/Sleep.zip
    unzip dataset/Sleep.zip -d dataset/Sleep
fi

# Tiselac data
if [ ! -f dataset/Tiselac.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/Tiselac.zip" -O dataset/Tiselac.zip
    unzip dataset/Tiselac.zip -d dataset/Tiselac
fi

# UrbanSound data
if [ ! -f dataset/UrbanSound.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/UrbanSound.zip" -O dataset/UrbanSound.zip
    unzip dataset/UrbanSound.zip -d dataset/UrbanSound
fi

# WalkingSittingStanding data
if [ ! -f dataset/WalkingSittingStanding.zip ]; then
    gdown "https://www.timeseriesclassification.com/aeon-toolkit/WalkingSittingStanding.zip" -O dataset/WalkingSittingStanding.zip
